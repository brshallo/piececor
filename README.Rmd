...
* Within the [easystats](https://github.com/easystats) ecosystem is the [correlation](https://easystats.github.io/correlation/articles/types.html) package / function that supports "Distance correlation" that measures both linear and non-linear associations.
